<?php 
    ...
    $lata = get_data_id_data("plant_products", "id", $category); // print_r($lata);   
?>
<!doctype html>
                              ...
                              id="product'.$j.'">
                                  <div class="product-large-thumb img-full">
                                     <div class="easyzoom easyzoom--overlay">
                                        <a href="backend/plant/'.$value.'">
                                            <img src="backend/plant/'.$value.'" alt="'.$lata['product_title'].'" >
                                        </a>
                                        <a href="backend/plant/'.$value.'" class="popup-img venobox" data-gall="myGallery">
                            ...
                            if($i==0)
                              ...
                              echo '  
                                  ...
                                  <div class="product-details-img">
                                    <a class="'.$active1.'" data-toggle="tab" href="#product'.$j.'"><img src="backend/plant/'.$value.'" alt="'.$lata['product_title'].'" ></a>
                                  </div>
                                  ';
                                $i++;
                                $j++;
