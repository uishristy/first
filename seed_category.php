                                            ...
                                            <ul>
                                              ...
                                              try {
                                                ...
                                                foreach ($menu as $key => $value) {
                                                    ...
                                                    echo '<li style="border-bottom:1px solid #ccc;"><a href="seed_category.php?e6da44926b498d999e97cf271a39e673='.base64_encode($value['category']).'">'.$value['category'].'</a></li>';
                                                }
                                           ?>  
                                            </ul>
                                      </div>
		                            ...
		                            <div id="grid" class="tab-pane fade show active">
		                                <div class="product-grid-view">
		                                    <div class="row">
                                                 <?php 
                        try {
                          $stmt = $pdo->prepare('SELECT * FROM `seed_products` WHERE category="'.$category.'" ORDER BY Date DESC');
     ...
     <div class="col-md-3 col-sm-12 mb-10">
		     <div class="single-product mb-25" style="border: 1px solid #009846;">
                    <div class="product-img img-full">
                             <a href="seed_desc.php?product_e6da44926b498d999e97cf271a39e673='.base64_encode($value['id']).'">
                              <img src="backend/seed/small_thumb/'.$value['thumbnail'].'"  alt="'.$value['product_title'].'">
                            </a>
                            <span class="onsale">Thawait</span>
                                                            
                    </div>
<div class="product-content" style="border-top: 2px solid  #009846;">
<h2><a href="seed_desc.php?product_e6da44926b498d999e97cf271a39e673='.base64_encode($value['id']).'">
'.$value['product_title'].'
</a></h2>
 ...
 <div class="price-box"  >
  <span class="regular-price">Rs. '.$value['price'].'</span>
                                                                ...
                                                                <div class="add-to-cart">
                                                                    <a href="seed_desc.php?product_e6da44926b498d999e97cf271a39e673='.base64_encode($value['id']).'">View Detail</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
