...
<?php $lata = get_data_id_data("fertilizer_products", "id", $_REQUEST['id']); //print_r($lata); ?>
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <form action="update_fertilizer_product_handle.php" method="POST" enctype="multipart/form-data">
              <div class="row">               
