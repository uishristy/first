 ...
 * smtp_message.php
 *
 * @(#) $Header: /opt2/ena/metal/mimemessage/smtp_message.php,v 1.37 2016/08/23 04:14:12 mlemos Exp $
 *
 *
 */
...
<class>
	...
	<version>@(#) $Id: smtp_message.php,v 1.37 2016/08/23 04:14:12 mlemos Exp $</version>
...
{metadocument}
	<variable>
		...
		<value>smtp $Revision: 1.37 $</value>
		<documentation>
...
{/metadocument}
*/
	var $mailer_delivery='smtp $Revision: 1.37 $';
...
*/
	...
	Function StartSendingMessage()
	{
		...
		$this->smtp->sasl_autoload = $this->smtp_autoload;
