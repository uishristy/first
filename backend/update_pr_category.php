...
<?php $lata = get_data_id_data("pr_category", "id", $_REQUEST['id']); //print_r($lata); ?>
        ...
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">                           
                            <li><a href="#"><?php echo $pdo_aauth['name']; ?></a></li>
            ...
            <div class="row">     
                <div class="col-xl-6 col-xs-3">
                    <form action="update_pr_category_handle.php" method="POST" >
                      <div class="card-box items">
                        <div style="padding-bottom: 5px;"></div>
                        <h2 style="font-size: 16px;">Update Product Category</h2> <hr/>
