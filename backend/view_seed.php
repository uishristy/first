            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">View seed</h4>
                       ...
                       <h3 style="color: #333;text-align:left;font-size: 20px">Products </h3>
                         <table  style="color: #333;" class="table table-striped table-hover">
                          ...
                          <tbody>
                            ...
                            try {
                                  $stmt = $pdo->prepare
                                  ('SELECT * FROM `seed_products`   ORDER BY date DESC');
                              ...
                              foreach($user as $key=>$value){
                                ...
                                echo '<tr>
                                    ...
                                    <td><img src="seed/small_thumb/'.$value['thumbnail'].'" style="width:50px"/></td>
                                    ...
                                    <td>'.$statys.'</td>      
                                    <th><a href="delete_seed_product.php?id='.$value['id'].'"><button class="btn btn-danger btn-sm">Delete</button></a> <a href="update_seed_product.php?id='.$value['id'].'"><button class="btn btn-info btn-sm">Update</button></a> </th>                        
                                  </tr>';
                                  $i++;
                            }           
                          ?>                    
