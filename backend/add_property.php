                ...
                <div class="col-xl-3 col-xs-12">
                    <div class="card-box items">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" required name="property_video" placeholder="Please Enter Youtube id Here" style="padding: 10px;">
                       </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control"  required name="balcony" placeholder="Please Enter No of Balcony" style="padding: 10px;">
                       </div>
             ...
             <div class="col-xl-3 col-xs-12" style="height: 1000px">
                    <div class="card-box items">
                        ...
                        <div class="form-group">
                         ...
                         <textarea class="form-control" required id="editor2"  name="facilities" placeholder="Enter Other Facilities" style="padding: 10px;"></textarea>
                       </div>
