                              ...
                              foreach($user as $key=>$value){                                 
                                echo '<tr>
                                   ...
                                   <td><label class="label label-success">'.$value['title'].'</label></td>
                                    <td><label class="label label-primary">'.$value['tags'].'</label><br/>
                                    '.substr(strip_tags(htmlspecialchars_decode($value['desc'])), 0,100).'
                                    </td>                                   
                                    <td>'.$value['date'].'</td>      
                                    <th><a href="delete_career.php?id='.$value['id'].'"><button class="btn btn-danger btn-sm">Delete</button></a> <a href="update_career.php?id='.$value['id'].'"><button class="btn btn-info btn-sm">Update</button></a> </th>                        
                                  </tr>';
                                  $i++;
                            }           
                          ?>                    
