    ...
    <div class="container" >
     <div style="">
        ...
        <div style="padding: 20px;text-align: center;position: relative;z-index: 10">
          ...
          <center>
            <button class="btn btn-info poik hvr-bounce-to-right" data-toggle="modal" data-target="#myModal2" style="background-color:#00a3ff;border:0px;font-weight: bold;">LOGIN</button>            
          </center>
        </div>
          ...
          <div class="modal-content">
            <form method="POST" action="login_redirect.php"  novalidate onsubmit="return validate();">
             <div style="padding: 40px;background-color: #fff">
                  <a href="index.php"><img src="../images/thawait_logo.png" style="width: 150px"></a>      
              ...
              <!-- <div style="padding: 10px;"></div>-->
               <div class="g-recaptcha" data-sitekey="6LfVNn4UAAAAAEqaGdnmnjLe5pCrPwPqqmAV1oCf"></div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                   <button class="inputss " name="login" style="width: 100%;background-color: #00a3ff">LogIn</button>
                  </div>
                </div>
                <br/>
