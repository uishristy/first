...
<?php $lata = get_data_id_data("category_data", "id", $_REQUEST['id']); //print_r($lata); ?>
        ...
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">                           
                            ...
                            <li class="active"> Update Blog Category </li>
                        </ol>
            ...
            <div class="row">     
                <div class="col-xl-6 col-xs-3">
                    <form action="update_product_category_handle.php" method="POST" >
                      <div class="card-box items">
                        <div style="padding-bottom: 5px;"></div>
                        <h2 style="font-size: 16px;">Update Blog Category</h2> <hr/>
