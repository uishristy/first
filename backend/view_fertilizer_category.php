            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">View fertilizer Category</h4>
                ...
                <div class="col-xl-12 col-xs-12">
                    <div class="card-box items">
                      <div style="padding: 10px;"></div>
                       <h3 style="color: #333;text-align:left;font-size: 20px">fertilizer  </h3>
                            ...
                            try {
                              ...
                              foreach($user as $key=>$value){                                 
                                echo '<tr>
                                    ...
                                    <td>'.$value['date'].'</td>      
                                    <th><a href="delete_fertilizer_category.php?id='.$value['id'].'"><button class="btn btn-danger btn-sm">Delete</button></a></th>                        
                                  </tr>';
                                  $i++;
                            }           
                          ?>                    
