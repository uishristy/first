            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">View Products Category</h4>
                            ...
                            try {
                              ...
                              foreach($user as $key=>$value){                                 
                                echo '<tr>
                                    ...
                                    <td>'.$value['date'].'</td>      
                                    <th><a href="delete_pr_gallery_category.php?id='.$value['id'].'"><button class="btn btn-danger btn-sm">Delete</button></a> <a href="update_pr_category.php?id='.$value['id'].'"><button class="btn btn-info btn-sm">Update</button></a> </th>                        
                                  </tr>';
                                  $i++;
                            }           
                          ?>                    
